...
int main()
{
  ...
  /// CALCULAMOS EL AUTOVECTOR MÍNIMO POR EL METODO DE LA POTENCIA INVERSA Y COMPROBAMOS LOS RESULTADOS
  ...
  printf("el autovalor minimo exacto es 0.3333 El calculado por el alumno es %1.4lf\n\n",a_max);
  printf("el autovector minimo exacto es :\n%lf \n%lf \n%lf \n\n",0.9309478,0.358060,0.071613);
  printf("el autovector minimo calculado por el alumno es\n");
  u.print("u");
