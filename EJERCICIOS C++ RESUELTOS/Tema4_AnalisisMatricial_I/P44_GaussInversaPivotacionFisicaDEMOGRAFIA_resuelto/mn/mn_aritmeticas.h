...
/// DEFINICION DE LA PRECISION DE LAS VARIABLES EN COMA FLOTANTE
#define real double

/// FUNCION PARA CALCULAR EL NÚMERO DE BITS DEDICADO A LA MANTISA
int mn_precision_aritmetica();


int mn_menor_numero_positivo();
int mn_mayor_numero_positivo();
real mn_distancia(real A,real B);
void mn_pivotar(real &A,real &B);
void mn_pivotar(int &A,int &B);
