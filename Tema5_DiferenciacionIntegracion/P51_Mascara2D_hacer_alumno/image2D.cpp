...
imageBMP::imageBMP(const char *name /** INPUT FILE NAME */ ){
   ...
   if (header.type != (int) 'M'*256+'B') {
     printf("Be careful, the file is not a image2D image file (magic number not correct)\n");
     //fprintf(stderr,"Be careful, the file is not a image2D image file (magic number not correct)\n");
